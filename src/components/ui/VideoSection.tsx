  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2">
      {videos.map((video, index) => (
        <FadeIn key={video.title} variant="scale" delay={index * 0.1}>
          <article className="overflow-hidden rounded-xl border border-brand-100 bg-white shadow-sm transition-shadow duration-300 hover:shadow-md">
            {video.embedUrl ? (
