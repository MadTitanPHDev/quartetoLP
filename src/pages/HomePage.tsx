    ...
    <>
        ...
        <div className="section-container grid min-h-[70vh] items-center gap-10 py-20 lg:grid-cols-2 lg:py-28">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#sobre"
                className="rounded-lg bg-white px-5 py-3 text-sm font-semibold text-brand-900 transition hover:bg-brand-50"
              >
                Conheça o Quarteto
              </a>
              <Link
      ...
      <Section id="sobre" title={aboutContent.title} subtitle={aboutContent.subtitle}>
        <div className="grid items-center gap-10 lg:grid-cols-2">
          ...
          <figure className="overflow-hidden rounded-2xl border border-brand-100 shadow-sm">
            <img
              src={aboutContent.image.src}
      ...
      >
        <div className="grid items-center gap-10 lg:grid-cols-2">
          <figure className="overflow-hidden rounded-2xl border border-brand-700">
            <img
          ...
          <div>
            ...
            <Link
              to={eventPreview.ctaPath}
              className="mt-8 inline-flex rounded-lg bg-accent-500 px-6 py-3 text-sm font-semibold text-white transition hover:bg-accent-600"
            >
              {eventPreview.ctaLabel}
            </Link>
          </div>
